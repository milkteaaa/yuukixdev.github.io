...
class _app {
  ...
  brandDescription = ['developed for you.', 'easy to use, free for life.', 'launch attack on ip addresses.', 'built with security in mind.', 'from UDP - TCP/IP flood to SYN/HTTP flood, dd0sware can do anything.', 'what are you waiting for?'];
